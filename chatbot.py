...
file_path = os.path.join(os.getcwd(), r"intents.json")  # Ensure intents.json is in the same directory as the script
if not os.path.exists(file_path):
    raise FileNotFoundError(f"Cannot find intents.json at {file_path}")
